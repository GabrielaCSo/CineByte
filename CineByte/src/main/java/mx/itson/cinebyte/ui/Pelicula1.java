...
public class Pelicula1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("VENOM EL ÚLTIMO BAILE");
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        if (!(txtNombre.getText().equals(""))) {
            ...
            Boleto boletoVenom = new Boleto(txtNombre.getText(), "Venom el último baile", asientos,(10*numeroAsientos));
            
            
            Main volver = new Main();
            volver.boletosVendidos.add(boletoVenom);
